...
/**
 * This is the "main" class, which starts the interface. Definition of the
 * interface buttons and tables is done in GuiController. FileLoader fills the
 * the second tab, War- and BattleDetailsContent fill those tabs.
 * 
